    ...
    for hid in SimInfo[sim]['halos']:
        try:
            rbins,rd,ba_s,ca_s,ba_d,ca_d = [StShapes[str(hid)]['rbins'],DMShapes[str(hid)]['rbins'],
                                            ...
                                            DMShapes[str(hid)]['ba'],DMShapes[str(hid)]['ca']]
            ...
            B_d.append(ba_d[indeff])
            C_d.append(ca_d[indeff])
            T_d.append(T(ba_d[indeff],ca_d[indeff]))
...
ax.plot([4,9.5],[1/3,1/3],c='.75',zorder=0)
ax.plot([4,9.5],[2/3,2/3],c='.75',zorder=0)
ax.tick_params(which='both',labelsize=15)
ax.text(4.05,1/6,'Oblate',fontsize=18,rotation='vertical',verticalalignment='center',c='.5')
ax.text(4.05,3/6,'Triaxial',fontsize=18,rotation='vertical',verticalalignment='center',c='.5')
ax.text(4.05,5/6,'Prolate',fontsize=18,rotation='vertical',verticalalignment='center',c='.5')
